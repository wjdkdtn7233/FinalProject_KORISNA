								...
								<div class="submission-form-inner">
									...
									<div class="row">
										...
										<div class="col-xl-12 col-lg-12 py-5">
											<h5 class="section-single-subtitle">* 사용하고 계신 이메일
												${sessionScope.loginUser.F_EMAIL} 는 탈퇴할 경우 재사용 및 복구가 불가능합니다.</h5>
											<p class="pl-5" style="color: #FF8224">탈퇴한 아이디는 본인과 타인 모두
												재사용 및 복구가 불가하오니 신중하게 선택하시기 바랍니다.</p>
										</div>

										<div class="col-xl-12 col-lg-12 py-5">
											<h5 class="section-single-subtitle">* 탈퇴 후 회원정보 및 개인형
												서비스 이용기록은 모두 삭제됩니다.</h5>
											<p class="pl-5" style="color: #FF8224">
												회원정보 개인형 서비스 이용기록은 모두 삭제되며, 삭제된 데이터는 복구되지 않습니다.<br>
												삭제되는 내용을 확인하시고 필요한 데이터는 미리 백업을 해주세요.
											</p>
										</div>

										<div class="col-xl-12 col-lg-12 py-5">
											<h5 class="section-single-subtitle">* 탈퇴 후에도
												게시물,채팅기록,댓글은 그대로 남아 있습니다.</h5>
											<p class="pl-5" style="color: #FF8224">
												삭제를 원하는 게시글,댓글이 있다면 반드시 탈퇴 전 삭제하시기 바랍니다.<br> 탈퇴 후에는
												회원정보가 삭제되어 본인 여부를 확인할 수 있는 방법이 없어, 게시글을 임의로 삭제해드릴 수 없습니다.
											</p>
										</div>

										<div class="col-xl-12 col-lg-12 pl-5 pt-5 pb-2">
											<hr>
											<h5 class="font-weight-bold pt-3" style="color: #FF8224">
												탈퇴 후에는 이메일 ${sessionScope.loginUser.F_EMAIL} 로 다시 가입할 수 없으며
												아이디와 데이터는 복구할 수 없습니다.<br>
												<br> 게시판형 서비스에 남아 있는 게시글 및 채팅기록,댓글은 탈퇴 후 삭제할 수 없습니다.<br>
											</h5>
										...
										<div class="col-xl-6 col-lg-6 col-md-6 pl-5 pb-5">
											...
											<div class="custom-control custom-checkbox">
												<input type="checkbox" id="jb-checkbox1"
													...
													class="custom-control-label" for="jb-checkbox1">안내
										...
										<div class="col-xl-2  col-lg-2  col-md-2  pl-5 ">
											...
											<h5 class="font-weight-bold pt-3 text-primary">비밀번호 입력
											</h5>
