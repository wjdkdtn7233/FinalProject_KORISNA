                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-12 col-lg-12">
                            <div class="section-title text-center semi-blue-section-title">
                                ...
                                <h2 class="section-heading-title">Have Any Question In Your Mind?
                                   <span class="section-blue-text">Let Us Now, We Are Help You.</span></h2>
                            </div>
                        </div>
                    </div>
                    <div class="contact-form-inner">
                        <div class="row">
                                ...
                                <table class="table" width="100%" cellspacing="0" role="grid"
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row" class="text-center">
                                            <td>제목</td>
                                            <td> <input type="text" id="q_subject" placeholder="Subject*"  onKeyDown="pressEnter()"/></td>
                                           
                                        </tr>
                                        <tr role="row" class="text-center">
                                            <td>내용</td>
                                            <td><textarea  id="q_content" cols="30" rows="10" placeholder="Message*"  onKeyDown="pressEnter()"></textarea></td>
                            ...
                            <div class="cta-main-button">
								<a class="cta-button btn" id="sendMessage" onclick="sendMessage()" >Send Message</a>
							</div>
                            </div>
                        </div>
                    </div>
	...
	function pressEnter(){
		...
		function sendMessage(){
			...
			if (confirm("위 내용으로 보내시겠습니까?") == true){ //확인
				...
				type: "post",
				data: { f_email : '${sessionScope.loginUser.F_EMAIL}', f_name : '${sessionScope.loginUser.F_NAME}',
					q_subject : $('#q_subject').val() , q_content : $('#q_content').val() },
