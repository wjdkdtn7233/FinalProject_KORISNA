                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 my-auto">
                            <div class="breadcrumb-content">
                                <h2 class="breadcrumb-main-title">productList</h2>
                                <ul>
                        ...
                        <div class="col-xl-12">
                            <div class="top-shop-bar">
                                <div class="row d-flex align-items-center">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4">
                                    <a href="<%=request.getContextPath()%>/product/productadd.do" class="common-btn btn common-hover-3">등록하기</a>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="product-bg-wrap" style="background-image: url(<%=request.getContextPath()%>/resources/product/image/${productList.P_IMAGE});">
                                                <div class="product-bg-hover">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="<%=request.getContextPath()%>/product/productdetailadmin.do?p_no=${productList.P_NO}" ><i class="fas fa-shopping-cart"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <c:if test="${productList.P_CNT != 0 }">
                                            <div class="product-info-wrap">
                                                <h4><a href="<%=request.getContextPath()%>/product/productdetailadmin.do?p_no=${productList.P_NO}" class="sunflower">${productList.P_NAME}</a></h4>
                                                ...
                                                <div class="cart-bottom sunflower">
                                                    <a href="<%=request.getContextPath()%>/product/productdetailadmin.do?p_no=${productList.P_NO}" class="common-btn btn common-hover-3">수정하기</a>
                                                </div>
                                            </div>
                                            </c:if>
                                            <c:if test="${productList.P_CNT == 0 }">
					...
					if(data != 'fail'){
						...
						for(var i=0; i<data.sortList.length; i++){
							 $('#productSort').append("<div class='col-xl-4 col-lg-4 col-md-6'>"+
										...
										"<div class='cart-bottom'><a href='<%=request.getContextPath()%>/product/productdetail.do?p_no="+data.sortList[i].P_NO+"' class='common-btn btn common-hover-3 sunflower'>수정하기</a></div></div></div></div>");
						}
