...
//		session 스토리지에 저장
	...
	public void selectLocationList(HttpSession session, HttpServletResponse response, @RequestParam Map<String, Object> commandMap) throws IOException {

		PrintWriter out = response.getWriter();
		JSONObject job = new JSONObject();
		List<Map<String, Object>> lList = (List<Map<String, Object>>) session.getAttribute("location");
//		선택한 것 받음
		Map<String, Object> res = is.selectLocationList(lList,Integer.parseInt((String) commandMap.get("locationNum")));
		if(!res.isEmpty()) {
