...
public class Board2 implements Serializable {
	...
	public Board2(String b2_yadmNm, String b2_sidocdNm, String b2_sggucdNm, String b2_addr, String b2_telno,
	...
	public String toString() {
		return "Board2 [B2_yadmNm=" + B2_yadmNm + ", B2_sidocdNm=" + B2_sidocdNm + ", B2_sggucdNm=" + B2_sggucdNm
				+ ", B2_addr=" + B2_addr + ", B2_telno=" + B2_telno + ", B2_XPos=" + B2_XPos + ", B2_YPos=" + B2_YPos
				+ "]";
	}
